        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="relative">
            ...
            <div className="mt-4 md:mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="bg-cbvt-navy text-white px-4 md:px-6 py-2 rounded-full text-sm md:text-[17px] font-alegreya-sans-sc hover:bg-opacity-90 transition-all whitespace-nowrap"
              >
                book now!
              </button>
            </div>
          ...
          <div className="relative">
            ...
            <div className="mt-4 md:mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <button
                onClick={() => navigate("/contact?service=Installation")}
                className="bg-cbvt-navy text-white px-4 md:px-6 py-2 rounded-full text-sm md:text-[17px] font-alegreya-sans-sc hover:bg-opacity-90 transition-all whitespace-nowrap"
              >
                book now!
              </button>
