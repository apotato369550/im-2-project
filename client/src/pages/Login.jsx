  ...
  export default function Login() {
    ...
    const [showuser_password, setShowuser_password] = useState(false);
            ...
            <div className="space-y-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  <div className="relative">
                    <input
                      type={showuser_password ? "text" : "password"}
                      name="user_password"
                    ...
                    <button
                      type="button"
                      onClick={() => setShowuser_password(!showuser_password)}
                ...
                {/* Remember Me & Forgot user_password */}
