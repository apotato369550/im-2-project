...
const Contact = () => {
  ...
  return (
    <>
      <section
        className="bg-cover bg-center bg-no-repeat w-full min-h-[1360px] overflow-hidden "
        style={{ backgroundImage: `url(${contactBg})`,
        backgroundSize: `contain`
       }}
      >
        <div className="relative mt-76 mx-32 z-10">
          <div className="grid gap-8 grid-cols-2 items-start">
            {/* Contact Info */}
            <div className="text-white order-1 w-full pl-24 pt-28">
        ...
        {/* Footer */}
        <div className="w-full flex justify-center items-center z-30 mt-90">
          <p className="text-lg font-semibold font-carme text-cbvt-light">
